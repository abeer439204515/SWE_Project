            ...
            <div class="contant">
                ...
                <form form action="updatePlantInformation.php" method="POST">
                    <fieldset>
                        ...
                        <input type="text" id="job" name="name" value="<?=$name?>"><br>

                        <label for="cate">Image:</label> <br>
                        <input type="text" id="cate" name="img" value="<?=$Img?>"><br>
                        ...
                        <input type="text" id="sal" name="price" value="<?=$Price?>"><br>

                        <label for="des">Description:</label>  <br>
                        <textarea name="des" rows="10" cols="64"><?=$Description?> </textarea> <br>
