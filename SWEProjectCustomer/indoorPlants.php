            ...
            <div class="row">
                ...
                for ($r = 0; $r < 2; $r++) {
                    ...
                    <div class="column">
                        ...
                        <div class="card">
                            <a href="productDetails.php?id=<?php echo $id[$j]; ?>" style="text-decoration: none"><img
                                        src="image/<?php echo $photo[$j] ?>" style="width:100%" class="cardimg"></a>
                            <h1> <?php echo $plant_name[$j] ?></h1>
                            <p class="price"><?php echo $price[$j] ?> SR</p>

                            <p>
                                <button onclick="AddToCart('<?php echo $plant_name[$j] ?>', '<?php echo $price[$j] ?>', 'image/<?php echo $photo[$j] ?>')">
                                    Add To Cart
                                </button>
                            </p>
                        </div>
