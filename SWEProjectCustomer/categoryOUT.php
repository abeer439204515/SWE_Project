...
require './connect.php'; 
$qurey2="SELECT * FROM plant WHERE category = 'outdoor' "; //offer id
...
<img src="image/arrow.png" alt="/" width="50" height= "50">
<a href="categoryOUT.html">Outdoor Plants</a>
	  </div>  
   </div>   
  </header>
 ...
 // $id[]= $row2['id'];
        ...
        <div class="row">
            ...
            <div class="column">
                ...
                <div class="card">
                    <a href="productDetails.php?id=<?php echo $id[$j]; ?>" style="text-decoration: none"><img src="image/<?php echo $photo[$j] ?>" style="width:100%" class="cardimg"></a>
   ...
   ?>
        ...
        <!--div class="row">
            ...
            <div class="column">
                ...
                <div class="card">
                    <img src="image/pot3.jpeg" style="width:100%">
                    <h1>plant</h1>
                    <p class="price">40 SR</p>
                    
                    <p><button onclick="AddToCart('pot_3', '40', null, 15, 'image/pot3.jpeg')">Add To Cart</button></p>
                </div>
            ...
            <div class="column">
                ...
                <div class="card">
                    <img src="image/pot4.jpeg" style="width:100%">
                    <h1>plant</h1>
                    <p class="price">20 SR</p>
                   
                    <p><button onclick="AddToCart('pot_4', '20', null, 15, 'image/pot4.jpeg')">Add To Cart</button></p>
                </div>
